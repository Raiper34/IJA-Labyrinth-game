...
/**
 * Trieda, ktora predstavuje vsetko graficke prostredie, znacna cast/kostra vytvorena v NetBeans
 * @author Filip Gulan (xgulan00)
 * @author Eduard Rybar (xrybar04)
 */
public class HlavneGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        volnaKartaGUI1 = new ija.ui.VolnePolickoGUI();
    ...
    /**
     * Metoda vykresluje Nastavenia obrazovku
     * @param evt 
     */
    ...
    /**
     * Metoda vykresluje Menu obrazovku
     * @param evt 
     */
    ...
    /**
     * Motoda na vykreslenie hernej obrazovky, spustenie vsetkoho, vytvaranie objektov...
     * @param evt 
     */
    private void StartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartActionPerformed
        ...
        ParentPanel.repaint();
        ParentPanel.revalidate();
        AllMainObjects.pocetHracovCelkovo = pocetHracovSlider.getValue();
        PocetHracoShow.setText("POCET HRACOV JE -> "+Integer.toString(AllMainObjects.pocetHracovCelkovo));
        ...
        else
        {
            ...
            AllMainObjects.balicekKariet = novybalicek;
            balicekKarty.setText(Integer.toString(novybalicek.size()));
            AllMainObjects.pocetUloh = 24;
        }
        AllMainObjects.balicekKariet.shuffle();
        ...
        PlayerTeam zoznamHracov = PlayerTeam.vytvorHracov(AllMainObjects.pocetHracovCelkovo,velkostPolaSlider.getValue(),velkostPolaSlider.getValue());
        ...
        AllMainObjects.undoVisible = 0;
        AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].uloha = -1;
        hracovaKartaGUI1.vytvorHracKartGui();
        vlozVolnuKartu.setVisible(true);
        skore.setText(Integer.toString(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].ziskaneBody));
        AllMainObjects.hracNaTahu = 1;
        tah.setText(Integer.toString(AllMainObjects.hracNaTahu));
    }//GEN-LAST:event_StartActionPerformed

    /**
     * Slider pocet hracov, nastavuje pocet hracov
     * @param evt 
     */
    ...
    /**
     * Metoda slider nastavuje velkost pola
     * @param evt 
     */
    ...
    /**
     * Metoda ukoncuje hru a vracia sa na orbazovku menu
     * @param evt 
     */
    ...
    /**
     * Metoda tlacidlo na dalsie kolo, prepne na dalsieho hraca
     * @param evt 
     */
    private void dalsiHracActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dalsiHracActionPerformed
        AllMainObjects.hracNaTahu = AllMainObjects.hracNaTahu + 1;
        
        if(AllMainObjects.pocetHracovCelkovo >= AllMainObjects.hracNaTahu)
        {
           tah.setText(Integer.toString(AllMainObjects.hracNaTahu));
        ...
        {
            kartaHraca.setText(Integer.toString(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].uloha));
        }
        hracovaKartaGUI1.vytvorHracKartGui();
        skore.setText(Integer.toString(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].ziskaneBody));
        vlozVolnuKartu.setVisible(true);
        AllMainObjects.vlozKamenVisible = 1;
        UNDObutton.setVisible(false);
        AllMainObjects.undoVisible = 0;
    ...
    /**
     * Metoda tlacidlo, na to aby si hrac mohol zobrat kartu/ulohu ak ziadnu nema
     * @param evt 
     */
    private void potiahnutKartuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_potiahnutKartuActionPerformed
        ...
        if(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].uloha == -1)
        {
            ...
            if( AllMainObjects.balicekKariet.size() != 0) 
            {
                //kartaHraca.setText(Integer.toString(AllMainObjects.balicekKariet.popCard().getCard().getCode()));
                AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].uloha = AllMainObjects.balicekKariet.popCard().getCard().getCode();
                kartaHraca.setText(Integer.toString(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].uloha));
                balicekKarty.setText(Integer.toString(AllMainObjects.balicekKariet.size()));
            }
        }
        hracovaKartaGUI1.vytvorHracKartGui();
        UNDObutton.setVisible(false);
    ...
    /**
     * Metoda na pohyb hraca hore, tlacidlo
     * @param evt 
     */
    private void pohybHoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pohybHoreActionPerformed
        int yPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX;
        int xPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY;
        if(1 != xPozH)
        {
          if ((AllMainObjects.hraciePole.plocha[xPozH][yPozH].karta.up != CANGO.NULL) && (AllMainObjects.hraciePole.plocha[xPozH-1][yPozH].karta.down != CANGO.NULL) )
            {
            AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY = AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY - 1;
            hraciGUI1.vytvorHraciGui(); 
            UNDObutton.setVisible(false);
            AllMainObjects.undoVisible = 0;
            }  
    ...
    /**
     * Metoda na pohyb hraca vpravo, tlacidlo
     * @param evt 
     */
    private void pohybVpravoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pohybVpravoActionPerformed
        int yPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX;
        int xPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY;
        if(AllMainObjects.hraciePole.riadky != yPozH)
        {
          if ((AllMainObjects.hraciePole.plocha[xPozH][yPozH].karta.right != CANGO.NULL) && (AllMainObjects.hraciePole.plocha[xPozH][yPozH+1].karta.left != CANGO.NULL) )
            {
            AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX = AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX + 1;
            hraciGUI1.vytvorHraciGui(); 
            UNDObutton.setVisible(false);
            AllMainObjects.undoVisible = 0;
            }  
    ...
    /**
     * Metoda na pohyb hraca dole, tlacidlo
     * @param evt 
     */
    private void pohybDoleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pohybDoleActionPerformed
        int yPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX;
        int xPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY;
        if(AllMainObjects.hraciePole.stlpce != xPozH)
        {
          if ((AllMainObjects.hraciePole.plocha[xPozH][yPozH].karta.down != CANGO.NULL) && (AllMainObjects.hraciePole.plocha[xPozH+1][yPozH].karta.up != CANGO.NULL) )
            {
            AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY = AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY + 1;
            hraciGUI1.vytvorHraciGui(); 
            UNDObutton.setVisible(false);
    ...
    /**
     * Metoda na vlozenie karty na surandice ziskane z text fieldov
     * @param evt 
     */
    private void vlozVolnuKartuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_vlozVolnuKartuMouseClicked
        ...
        int max = AllMainObjects.hraciePole.riadky;
        if ((currentX > max) || (currentY > max)) //podmienky kedy nemoze vlozit kartu
        {
        ...
        {
            if((AllMainObjects.undoX == 1 && currentX == max && AllMainObjects.undoY == currentY ) || (AllMainObjects.undoX == max && currentX == 1 && AllMainObjects.undoY == currentY))
            {
                chybaButton.setVisible(true);
            }
            else if ((AllMainObjects.undoY == 1 && currentY == max && AllMainObjects.undoX == currentX ) || (AllMainObjects.undoY == max && currentY == 1 && AllMainObjects.undoX == currentX))
            {
                 chybaButton.setVisible(true);
            }
            ...
            else //moze vlozit kartu
            {
                MazeField pomocny = AllMainObjects.hraciePole.get(currentX, Integer.parseInt(stlpecZadanie.getText()));
                AllMainObjects.hraciePole.shift(pomocny);
                hraciaPlochaGUI1.vytvorGui();
                volnaKartaGUI1.vytvorVolnuGui();
                pokladyGUI1.vytvorPokladyGui();
                volnyPokladGUI1.vytvorVolnuPGui();
                ...
                AllMainObjects.vlozKamenVisible = 0;
                AllMainObjects.undoX = Integer.parseInt(riadokZadanie.getText());
                AllMainObjects.undoY = Integer.parseInt(stlpecZadanie.getText()); 
                UNDObutton.setVisible(true);
                AllMainObjects.undoVisible = 1;
            }
        }
    ...
    /**
     * Metoda na pohyb hraca vlavo, tlacidlo
     * @param evt 
     */
    private void pohybVlavoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pohybVlavoActionPerformed
        ...
        if(1 != yPozH)
        {
          if ((AllMainObjects.hraciePole.plocha[xPozH][yPozH].karta.left != CANGO.NULL) && (AllMainObjects.hraciePole.plocha[xPozH][yPozH-1].karta.right != CANGO.NULL) )
            {
            AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX = AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX - 1;
            hraciGUI1.vytvorHraciGui(); 
            UNDObutton.setVisible(false);
    ...
    /**
     * Metoda na zobranie ulohy zo zeme, ak ma hrac totoznu ulohu
     * @param evt 
     */
    private void zoberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zoberActionPerformed
        int yPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaX;
        int xPozH=AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].poziciaY;
        if((AllMainObjects.hraciePole.plocha[xPozH][yPozH].karta.uloha == AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].uloha) && (AllMainObjects.hraciePole.plocha[xPozH][yPozH].karta.uloha != -1))
        {
            AllMainObjects.hraciePole.plocha[xPozH][yPozH].karta.uloha = -1;
            AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].uloha = -1;
            AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].ziskaneBody = AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].ziskaneBody + 1;
            skore.setText(Integer.toString(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].ziskaneBody));
            pokladyGUI1.vytvorPokladyGui();
            hracovaKartaGUI1.vytvorHracKartGui();
            UNDObutton.setVisible(false);
            ...
            if(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].ziskaneBody == AllMainObjects.balicekKariet.maxSize/AllMainObjects.pocetHracovCelkovo)
            {
                ParentPanel.removeAll();
                ParentPanel.add(VyhraPanel);
                ParentPanel.repaint();
                ParentPanel.revalidate();
                vyherca.setText(Integer.toString(AllMainObjects.hracNaTahu));
            }
    ...
    /**
     * Metoda ktora impkementuje funkciu undo
     * @param evt 
     */
    private void UNDObuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UNDObuttonActionPerformed
        MazeField pomocny;
        if (AllMainObjects.undoX==1)
        {
            pomocny = AllMainObjects.hraciePole.get(AllMainObjects.hraciePole.riadky, AllMainObjects.undoY);
        }
        else if (AllMainObjects.undoX==AllMainObjects.hraciePole.riadky)
        {
            pomocny = AllMainObjects.hraciePole.get(1, AllMainObjects.undoY);
        }
        else if (AllMainObjects.undoY==1)
        {
            pomocny = AllMainObjects.hraciePole.get(AllMainObjects.undoX, AllMainObjects.hraciePole.riadky);
        }
        else  
        {
            pomocny = AllMainObjects.hraciePole.get(AllMainObjects.undoX, 1);
        }
    ...
    /**
     * Metoda, tlacidlo, ktora vola metodu na ulozenie hry
     * @param evt 
     */
    ...
    /**
     * Metoda tlacidlo, ktora vola metodu na nacitanie hry
     * @param evt 
     */
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
          ...
          tah.setText(Integer.toString(AllMainObjects.hracNaTahu));
          skore.setText(Integer.toString(AllMainObjects.poleHracov.poleHracov[AllMainObjects.hracNaTahu].ziskaneBody));
          balicekKarty.setText(Integer.toString(AllMainObjects.balicekKariet.actSize));
          PocetHracoShow.setText("POCET HRACOV JE -> "+Integer.toString(AllMainObjects.poleHracov.pocetHracov));
          
          if (AllMainObjects.undoVisible == 0 )
          {
              UNDObutton.setVisible(false);
              
          }
          if (AllMainObjects.vlozKamenVisible == 0)
          {
              vlozVolnuKartu.setVisible(false);
          }
    ...
    private ija.ui.VolnePolickoGUI volnaKartaGUI1;
